...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-12">
            {/* global styles — exact Login palette */}
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap');
                *{font-family:'Inter',system-ui,sans-serif}
                /* Same muted teal gradient as Login for tagline */
                .grad-text{
                ...
                /* Exact Login focus ring — subtle teal */
                .input-focus:focus{border-color:#5eead4;box-shadow:0 0 0 3px rgba(20,184,166,.08)}
            ...
            {/* background — exact Login gradient */}
            <div
            ...
            {/* decorative blobs — exact Login colors & opacity */}
            ...
            {/* dot pattern overlay — exact Login opacity */}
            ...
            {/* floating decorative elements — exact Login tints */}
            ...
            <div className="relative z-10 w-full max-w-md px-5 sm:px-0 card-enter">
                {/* logo + brand — EXACT Login logo gradient (teal-600 → teal-400) */}
                <div className="text-center mb-7">
                    <button
                        onClick={() => navigate('/')}
                        className="inline-flex items-center gap-2.5 group mb-4"
                    >
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-600 to-teal-400 flex items-center justify-center shadow-md shadow-teal-400/15 group-hover:shadow-teal-400/30 transition-shadow duration-300">
                            <svg
                    ...
                    {/* tagline — exact Login gradient text */}
                    <h2 className="text-lg font-bold text-gray-800 mb-1">
                        Your Health, <span className="grad-text">Our Priority.</span>
                    </h2>
                ...
                {/* register card */}
                <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-lg shadow-gray-200/40 border border-gray-100 p-8">
                    ...
                    {success && (
                        <div className="mb-5 p-4 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-start gap-3">
                    ...
                    <form className="space-y-4" onSubmit={handleRegister}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    className="input-focus w-full border border-gray-200 rounded-xl pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 focus:outline-none bg-gray-50/50 hover:bg-gray-50 transition-colors duration-200 text-sm"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="input-focus w-full border border-gray-200 rounded-xl pl-12 pr-12 py-3.5 text-gray-900 placeholder-gray-400 focus:outline-none bg-gray-50/50 hover:bg-gray-50 transition-colors duration-200 text-sm"
                                    placeholder="••••••••"
                                    value={password}
                        ...
                        {/* submit button — exact Home primary button style */}
                        <button
                            type="submit"
                            disabled={loading}
                            className="btn-hover w-full py-3.5 text-white font-semibold rounded-full bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 shadow-lg shadow-teal-400/20 hover:shadow-teal-400/30 focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:ring-offset-2 transition-all duration-300 text-[15px] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none mt-6"
                        >
                            {loading ? (
                                <>
                                    <svg className="spin w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    ...
                    {/* login link — exact Home accent color */}
